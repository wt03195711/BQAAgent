...
/**
 * Checks GitHub Releases for a newer version of BQAAgent.
...
public class UpdateChecker {
    ...
    private static final String GITHUB_API = "https://api.github.com/repos/agents-io/BQAAgent/releases/latest";
    ...
    public static void checkForUpdate(Activity activity) {
        ...
        long lastCheck = io.agents.bqaagent.utils.KVUtils.INSTANCE.getLong("last_update_check", 0);
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            try {
                ...
                // Save check time
                io.agents.bqaagent.utils.KVUtils.INSTANCE.putLong("last_update_check", now);
