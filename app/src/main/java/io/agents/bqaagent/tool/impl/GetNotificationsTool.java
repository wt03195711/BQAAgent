    ...
    public ToolResult execute(Map<String, Object> params) {
        ...
        try {
            ...
            for (StatusBarNotification sbn : notifications) {
                // Skip BQAAgent's own notifications
                if ("io.agents.bqaagent".equals(sbn.getPackageName())) continue;
            ...
            if (count == 0) {
                return ToolResult.success("No active notifications (only BQAAgent system notifications present).");
            }
