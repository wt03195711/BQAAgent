...
object TaskPromptEnvelope {
    ...
    private const val HISTORY_START = "<<<BQAAGENT_CHAT_HISTORY>>>"
    private const val HISTORY_END = "<<<END_BQAAGENT_CHAT_HISTORY>>>"
    private const val BACKGROUND_START = "<<<BQAAGENT_BACKGROUND_STATE>>>"
    private const val BACKGROUND_END = "<<<END_BQAAGENT_BACKGROUND_STATE>>>"
    private const val REQUEST_START = "<<<BQAAGENT_CURRENT_REQUEST>>>"
    private const val REQUEST_END = "<<<END_BQAAGENT_CURRENT_REQUEST>>>"
