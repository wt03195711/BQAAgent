 ...
 *
 * Models are downloaded from ModelScope and stored in the app's
...
object LocalModelManager {
    ...
    val AVAILABLE_MODELS = listOf(
        ModelInfo(
            ...
            url = "https://modelscope.cn/models/litert-community/gemma-4-E2B-it-litert-lm/resolve/master/gemma-4-E2B-it.litertlm",
        ...
        ModelInfo(
            ...
            url = "https://modelscope.cn/models/litert-community/gemma-4-E4B-it-litert-lm/resolve/master/gemma-4-E4B-it.litertlm",
    ...
    private fun canWriteToDirectory(dir: File): Boolean {
        val probe = File(dir, ".bqaagent-write-probe")
        return runCatching {
    ...
    fun downloadModel(
        ...
        try {
            ...
            if (!tempFile.renameTo(targetFile)) {
                callback.onError("Download finished but BQAAgent could not move the model into place")
                return
            }
