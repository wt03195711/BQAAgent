 ...
 *
 * This fires reliably on notification updates — fixing the bug where WhatsApp
 * updates an existing notification instead of creating a new one.
 *
 ...
 *
 * Requires: Settings → Notification Access → BQAAgent enabled.
 */
public class ClawNotificationListener extends NotificationListenerService {
    ...
    private void maybeReturnToAppAfterPermissionFlow() {
        ...
        mainHandler.postDelayed(() -> {
            try {
                android.content.Intent intent = new android.content.Intent(this, io.agents.bqaagent.ui.settings.SettingsActivity.class);
