 ...
 *
 * Usage:
 *   adb shell am broadcast -a io.agents.bqaagent.TASK --es task "send hi to Mom on WhatsApp" -p io.agents.bqaagent
 *   adb shell am broadcast -a io.agents.bqaagent.TASK --es chat "read my clipboard and explain what it says" -p io.agents.bqaagent
 *   adb shell am broadcast -a io.agents.bqaagent.TASK --es chat_b64 "$(printf 'remember token abc123 and reply with only OK' | base64 -w0)" -p io.agents.bqaagent
 *
...
public class TaskTriggerReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION = "io.agents.bqaagent.TASK";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (hasTask && task.startsWith("autoreply ")) {
            ...
            if (cmd.equals("off")) {
                io.agents.bqaagent.service.AutoReplyManager.getInstance().stopAll();
