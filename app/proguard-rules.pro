...
# Agent 相关（反射/SPI）
-keep class io.agents.bqaagent.agent.langchain.http.** { *; }
-keep class io.agents.bqaagent.agent.** { *; }

# Tool 注册（反射）
-keep class io.agents.bqaagent.tool.** { *; }

# Channel（钉钉/飞书回调，保留泛型签名）
-keep class io.agents.bqaagent.channel.** { *; }
